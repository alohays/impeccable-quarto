...
## {background-image="https://github.com/alohays/impeccable-quarto/releases/download/v0.1.0-assets/cover.png" background-size="cover" background-position="center"}
...
:::: {.three-col}
::: {.column}
![GTA driving scene](https://github.com/alohays/impeccable-quarto/releases/download/v0.1.0-assets/demo-gta.png){width="100%"}
...
:::: {.two-col}
::: {.column}
![GTA scene detail](https://github.com/alohays/impeccable-quarto/releases/download/v0.1.0-assets/demo-gta.png){width="100%"}
:::
